...
@Service("homepageComfCnsService")
public class HomepageComfCnsServiceImpl extends EgovAbstractServiceImpl implements HomepageComfCnsService {

	private static final Logger LOGGER = LoggerFactory.getLogger(HomepageComfCnsServiceImpl.class);
	
	/** SampleDAO */
	// TODO ibatis 사용
	@Resource(name = "homepageComfCnsMapper")
	private HomepageComfCnsMapper homepageComfCnsMapper;
	// TODO mybatis 사용
	//  @Resource(name="sampleMapper")
	//	private SampleMapper sampleDAO;
	
	// 상담신청 등록
	public void insertComfCnsReg(ComfCnsVO vo){
		try {
			homepageComfCnsMapper.insertComfCnsReg(vo);
		} catch (Exception e) {
	...
	public void insertAddComfCnsReg(AddComfCnsVO vo) {
		homepageComfCnsMapper.insertAddComfCnsReg(vo);
	}
