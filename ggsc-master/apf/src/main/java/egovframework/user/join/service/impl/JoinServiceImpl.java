 ...
 */
package egovframework.user.join.service.impl;
...
public class JoinServiceImpl extends EgovAbstractServiceImpl implements JoinService {
	...
	@Override
	public void selectJoinView(JoinVO vo) throws Exception {
		
		LOGGER.debug("CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC");
		
			joinMapper.selectJoinView(vo);
		
	}


	@Override
	public int checkId(JoinVO vo) throws Exception {
		
		LOGGER.debug("CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC");
		
		return joinMapper.checkId(vo);
