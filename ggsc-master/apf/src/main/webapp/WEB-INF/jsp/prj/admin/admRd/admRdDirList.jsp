...
<div class="wrap"> 
	...
	<div class="container">
		...
		<div class="content"> 
			...
			<p class="board_total">Total : ${paginationInfo.totalRecordCount} (의료요양지시서 관련된 <b>Excel파일만 등록 가능합니다)</b></p>
			<!-- list  start -->
			...
			<c:forEach var="result" items="${admRdDirList}" varStatus="status">
...
<!-- /wrap -->  
    ...
    <script type="text/javaScript" language="javascript" defer="defer">
        ...
        function fn_detail(rdNum) {
        	...
        	document.admRdFrm.action = "/admRdDirView.do";
           	document.admRdFrm.submit();
        }
