...
<div class="wrap"> 
	...
	<div class="container">
		...
		<div class="content"> 
			...
			<p class="board_total">Total : ${paginationInfo.totalRecordCount} (신택계약과 관련된 <b>Excel파일만 등록 가능합니다)</b></p>
			<!-- list  start -->
			...
			<c:forEach var="result" items="${admRdBdList}" varStatus="status">
...
<!-- /wrap -->  
    ...
    <script type="text/javaScript" language="javascript" defer="defer">
        ...
        function fn_Reg() {
           	...
           	document.admRdFrm.action = "/admRdBdRegMove.do";
           	document.admRdFrm.submit();
        }
