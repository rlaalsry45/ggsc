  ...
  <body>
    ...
    <div class="container content-wrapper">
      ...
      <div class="btn-wrap"><!-- 임시링크  -->
        <a class="btn btn-normal btn-xs" href="/gnoincoun/cnsAskList.do" role="tab">상담문의</a>
		        ...
		        <table  class="table table-condensed">
		          ...
		          <tbody>
		            ...
		            <tr>
		              ...
		              <td><c:out value="${list.ansCntn }"/></td>
		            </tr>
		            <tr>
      ...
      <div class="btn-wrap">
        <button type="button" onclick="location.href='/gnoincoun/onlineCnsWrite.do'" class="btn btn-primary btn-lg w100p">글쓰기</button>
      </div>
      <div class="btn-wrap line bt bb pt10 pb10">
        <button type="button" class="btn btn-default" onclick="location.href='/gnoincoun/'">홈</button>
