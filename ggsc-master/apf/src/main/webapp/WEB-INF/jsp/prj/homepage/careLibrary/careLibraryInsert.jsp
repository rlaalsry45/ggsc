  ...
  <script>
  	...
  	function fn_reg() {
		if(confirm("등록 하시겠습니까?")){
			document.frm.action = "/gnoincoun/careLibraryReg.do";
	       	document.frm.submit();
		}		
  	}
  </script>
        ...
        <form class="form-wrap" id="frm" name="frm" method="post" enctype="multipart/form-data">
          ...
          <div class="btn-wrap line bt mt20 pt20 pb20">
            <button type="button" class="btn btn-primary btn-lg w100p" id="save" onClick="javascript:fn_reg();">등록하기</button>
          	<button type="button" class="btn btn-primary btn-lg w100p" id="save" onclick="location.href='/gnoincoun/careLibraryList.do'" style="color: #fff; background-color: #78849E; border-color: #78849E;">목록</button>
          </div>
        </form>
      </div><!-- .content-area /-->
