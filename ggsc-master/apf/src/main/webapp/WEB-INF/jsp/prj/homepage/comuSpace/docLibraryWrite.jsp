  ...
  <script>
	...
	function fn_noticeReg() {
		if(confirm("등록 하시겠습니까?")){
			document.frm.action = "/gnoincoun/docLibraryReg.do";
	       	document.frm.submit();
		}	
	}
  </script>
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu"  role="menu">
                ...
                <li class="dropdown-item active"><a href="/gnoincoun/docLibraryList.do">문서자료실<i class="fa fa-caret-right"></i></a></li>
      ...
      <div class="content-area">
        <form class="form-wrap" id="frm" name="frm" method="post" enctype="multipart/form-data">
          ...
          <div class="btn-wrap line bt bb pt10 pb10 mt20 text-center hidden-xs">
            <button type="button" onclick="javascript:fn_noticeReg();"class="btn btn-primary btn-lg fr">등록하기</button>
          </div>
           <!-- 모바일용 -->
          <div class="btn-wrap line bt mt20 pt20 pb20  visible-xs">
            <button type="button" onclick="javascript:fn_noticeReg();" class="btn btn-primary btn-lg w100p">등록하기</button>
          </div>
