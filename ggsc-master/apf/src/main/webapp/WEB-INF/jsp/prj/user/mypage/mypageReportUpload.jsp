...
<%@ taglib prefix="spring" uri="http://www.springframework.org/tags"%>
	        ...
	        <div class="container">
	            <div class="row">
					<div class="col-md-12 col-sm-12">
						...
						<h3 class="title"><b>감독기록 업로드</b></h3>
						<!-- view  start -->
						<div class="form_table">
							<form id="admCdFrm" name="admCdFrm" method="post" enctype="multipart/form-data">
									<table class="notice_view" border="1" cellspacing="0" summary=""> 
										...
										<input type="hidden" id="rpt2_id" name="rpt2_id" value="${mypageVO.rpt2_id}" >
										<tr> 
											<th>작성자</th> 
											<td>${mypageVO.witr_name}</td> 
											<th>제1대리인</th> 
											<td>${mypageVO.rpt2_name}</td>
										</tr>
										<tr> 
											<th>보고서 업로드</th> 
											<td colspan="3">
    ...
    <script type="text/javaScript" language="javascript" defer="defer">
	    ...
	    function fn_list() {
	    	...
	    	document.mypageFrm.action = "/mypageReportMain.do";
		...
		function fn_upload() {
	    	...
	    	document.mypageFrm.action = "/mypageReportUpload.do";
	       	document.mypageFrm.submit();
	    }
