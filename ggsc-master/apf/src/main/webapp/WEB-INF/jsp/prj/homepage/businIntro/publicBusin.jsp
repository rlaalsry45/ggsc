  ...
  <body>
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu"  role="menu">
                ...
                <li class="dropdown-item active"><a href="/gnoincoun/publicBusin.do">홍보사업<i class="fa fa-caret-right"></i></a></li>
    ...
    <div class="container content-wrapper">
      <div class="page-header">
        <h1 class="title"><i class="fa fa-question"></i>홍보사업</h1>
        <ol class="breadcrumb">
          <li><a href="/gnoincoun/homepageMainList.do">홈</a></li>
          <li><a href="#">사업소개</a></li>
          <li class="active">홍보사업</li>
        </ol>
      </div>
      <div class="content">
        <div class="cont-box">
          <h3>시・군 노인상담센터의 지역 내 다양한 홍보를 위한 홍보활동 </h3>
          <blockquote>(홍보물품 배포, 인력지원, 물품대여 등)지원 </blockquote>
          <h3>지역사회 내 노인상담사업 및 경기도노인종합상담센터의 효과적 홍보를 위한 활동 진행 </h3>
          ...
          <blockquote>
            <table class="basic">
              ...
              <tr>
                <td>홍보물품 제작 </td>
                <td class="l"> - 경기도노인종합상담센터 홍보 및 시․군 노인상담센터 홍보 지원을 위한 물품 제작</td>
              </tr>
              <tr>
                <td> 지역사회 홍보 </td>
                <td class="l"> - 노인관련 지역행사 참여를 통하여 노인상담센터사업 홍보<br>
                  - 상․하반기 행사 노인관련 행사에서 홍보부스 운영</td>
              </tr>
              <tr>
                <td>시ㆍ군노인상담<br>
                  센터홍보지원 </td>
                <td class="l"> - 경기도 시․군 노인상담센터 홍보 지원</td>
              </tr>
              <tr>
                <td> 홈페이지 관리 </td>
                <td class="l"> ­ 경기도노인종합상담센터 및 시・군 상담센터의 홍보, 정보제공 </td>
              </tr>
              <tr>
                <td> 언론보도 </td>
                <td class="l"> ­ 언론사를 통해 경기도 시․군 노인상담센터 사업 지역사회 홍보</td>
              </tr>
            </tbody></table>
          </blockquote>
        </div>
