  ...
  <body>
          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu"  role="menu">
                ...
                <li class="dropdown-item active"><a href="/gnoincoun/operatCorp.do">운영법인<i class="fa fa-caret-right"></i></a></li>
    ...
    <div class="container content-wrapper">
      <div class="page-header">
        <h1 class="title">운영법인</h1>
        <ol class="breadcrumb">
          <li><a href="/gnoincoun/homepageMainList.do">홈</a></li>
          <li><a href="#">센터소개</a></li>
          <li class="active">운영법인</li>
        </ol>
      </div>
      <div class="content">
        <div class="cont-box">
          <h3>운영법인 소개</h3>
          <article>경기도사회서비스원은 국책사업을 위해 경기도가 100% 출연한 공공기관으로 비영리 재단법인입니다. </article>
          <ul class="col-set">
            <li>
              <b>01</b>
              <em>법인명</em>
              <span class="bold">경기도사회서비스원</span>
            </li>
            <li>
              <b>02</b>
              <em>재단설립일</em>
              <span class="bold">2020.01.29.</span>
            </li>
            <li>
              <b>03</b>
              <em>소재지</em>
              <span>경기도 수원시 장안구 경수대로 1150 건강증진센터 1층 (파장동)</span>
            </li>
            <li>
              <b>04</b>
              <em>연락처</em>
              <span>TEL 031-267-9389<br>
              FAX 070-8280-0090<br>
              홈페이지. gg.pass.or.kr</span>
            </li>
          </ul>
        </div>
      </div><!-- .content /-->
