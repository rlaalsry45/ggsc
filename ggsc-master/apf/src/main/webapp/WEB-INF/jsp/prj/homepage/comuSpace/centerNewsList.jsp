  ...
  <script>
		$(document).ready(function() {
	  	...
	  	function fn_detail(num){
			document.location.href = "/gnoincoun/centerNewsDtl.do?num="+num;
		}
        ...
        function fn_egov_link_page(pageNo){
        	...
        	document.frm.action = "/gnoincoun/centerNewsList.do";
           	document.frm.submit();
        }
        
        function fn_searchForm() {
        	document.searchForm.action = "/gnoincoun/centerNewsList.do";
