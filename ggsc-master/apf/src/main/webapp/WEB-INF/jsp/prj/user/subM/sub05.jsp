          ...
          <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="sub05.html">알려드려요 &amp; 자유게시판<i class="fa fa-caret-right"></i></a></li>
        ...
        <div class="tab-pane fade in active" id="notice" role="tabpanel" aria-labelledby="notice-tab">
         <!-- <h2 class="title">알려드려요</h2>-->
          ...
          <div class="btn-wrap p15">
            <button type="button" onclick="location.href='write.html'" class="btn btn-primary btn-lg w100p">글쓰기</button>
          </div>
        </div><!-- .tab-pane -->
            ...
            <ul class="list_area">
              ...
              <li class="board_box" >
                <a href="view.html" onclick="" class="txt_area">   
                  ...
                  <!-- 새글알림 //-->
                  <!-- 제목 -->
                  <strong class="tit">코로나19보다 더 무서운 것은 :심리방역 붕괴" 염려 </strong>
                  <!-- 제목 //-->
                  <!-- 글등록정보 -->
                  <div class="user_area">
                    <span class="nick">
              ...
              <li class="board_box" >
                <a href="view.html" onclick="" class="txt_area">   
                  ...
                  <!-- 새글알림 //-->
                  <!-- 제목 -->
                  <strong class="tit">특강 : 코로나이후 시대의 심리방역 : 마음공부로 진정한 이(利)기(己)주의자 되기</strong>
                  <!-- 제목 //-->
                  <!-- 글등록정보 -->
                  <div class="user_area">
                    <span class="nick">
              ...
              <li class="board_box" >
                <a href="view.html" onclick="" class="txt_area">   
                  <!-- 제목 -->
                  <strong class="tit">[응급알림서비스 강화한다]</strong>
                  <!-- 제목 //-->
                  <!-- 글등록정보 -->
                  <div class="user_area">
                    <span class="nick">
              ...
              <li class="board_box" >
                <a href="view.html" onclick="" class="txt_area">   
                  <!-- 제목 -->
                  <strong class="tit">노인상담센터 상담사, 보수교육 진행</strong>
                  <!-- 제목 //-->
                  <!-- 글등록정보 -->
                  <div class="user_area">
                    <span class="nick">
