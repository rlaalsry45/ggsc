		...
		$.ajax({
			...
			success : function(json) {
				...
				if( 0 == json.list.length ) {
					html = '<tr><td colspan="5" rowspan="' + json.vo.pageRows + '" >데이터가 없습니다.</td></tr>';
				} else {
					$.each(json.list, function(i, d) {
						html += '<tr onclick="dtl1(\''+ d.comNo +'\');">';
						html += '<td>' + d.comCd + '</td>';
						html += '<td>' + d.comNm + '</td>';
...
<div class="box-style1 x-scroll-auto" >
	...
	<form name="schForm" id="schForm" action="/codeDtl.do" method="post" >
			...
			<div class="search-group">
				<span class="label">
					<select id='schColm' name="schColm" >
						<option value="1">코드명</option>
	    				<option value="2">코드그룹명</option>
	  				</select>
				</span>
				<span class="form">
