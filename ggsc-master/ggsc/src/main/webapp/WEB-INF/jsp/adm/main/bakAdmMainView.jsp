...
<html>
  ...
  <body class="nav-md">
          ...
          <div class="nav_menu">
            <nav>
              ...
              <ul class="nav navbar-nav navbar-right">
				...
				<li>
                  <a href="">
                  	<button type="button" class="btn btn-round btn-warning"><strong>로그아웃</strong></button>
                  </a>
		  ...
		  <div class="row">
			<div class="col-md-4 col-sm-4 col-xs-12">
              <div class="x_panel tile fixed_height_260">
                ...
                <div class="x_content">
                  <h4>총 인원현황</h4>
                  <c:forEach var="pb" items="${mainTotal}" varStatus="status">
                  <div class="widget_summary">
                    <div class="w_left w_25">
                      <span><c:out value="${pb.pbNm }" /></span>
                    </div>
                    <div class="w_center w_55">
                      <div class="progress">
                        <div class="progress-bar bg-green" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 66%;">
                          <span class="sr-only"><c:out value="${pb.tot }" /> Complete</span>
                        </div>
                      </div>
                    </div>
                    <div class="w_right w_20">
                      <span><c:out value="${pb.tot }" /></span>
                    </div>
                    <div class="clearfix"></div>
                  </div>
                  </c:forEach>
                  ...
                  <div class="dashboard-widget-content">
                    ...
                    <div class="sidebar-widget">
                      ...
                      <div class="goal-wrapper">
                        ...
                        <span id="gauge-text" class="gauge-value pull-left"><c:out value="${signTotal.signCnt}" /></span>
                        <span id="goal-text" class="goal-value pull-right"><c:out value="${signTotal.docTot}" /></span>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      $(document).ready(function(){
        ...
        new Chart(document.getElementById("canvas1"), {
          ...
          data: {
            ...
            datasets: [{
              data: [<c:out value="${pbRels10.relCnt}" />, <c:out value="${pbRels11.relCnt}" />, <c:out value="${pbRels12.relCnt}" />],
              backgroundColor: [
                                "#1abb9c",
                                "#9b59b6",
                                "#3498db"
    ...
    <script>
      ...
      gauge.maxValue = <c:out value="${signTotal.docTot}" />;
      gauge.animationSpeed = 32;
      gauge.set(<c:out value="${signTotal.signCnt}" />);
