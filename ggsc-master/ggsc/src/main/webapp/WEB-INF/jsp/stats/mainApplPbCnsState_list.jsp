...
<script type="text/javascript">
	...
	function list() {
		...
		$.ajax({
			type : "POST",
			url : "/gnoincoundb/mainApplPbCnsStateList_ajax.do",
...
<section id="content">
	...
	<h2 class="h2-title"><i class="fa fa-check-square"></i>주호소별 상담현황</h2>
		...
		<form name="searchForm" id="searchForm" action="/bbsList.do" method="post" onsubmit="return false">
			...
			<h3 class="h3-title" style="margin-top: 15px;">주호소별 상담현황</h3>
