...
<div id="wrap">
	...
	<!-- 타이틀이미지, 로그인 시작 -->
	<div id="titlewrap">
		<div class="main_img"><img src="/images/header/img_portal_title.gif" width="719" height="94" alt="" /></div>
	...
	<div id="bodywrap">
		<div id="leftcontent_wrap">
			...
			<div class="leftcontent01">
				<div class="leftcontent01_title"><img src="/images/header/img_leftcontent_title01.gif" width="228" height="31" alt="한번에 신청하는 민원" /></div>
				<div class="btn_detail01"><a href="#LINK" onclick="javascript:goMenuPage('2000000'); return false;" ><img src="/images/header/btn_detailview.gif" width="71" height="17" alt="자세히 보기" title="자세히 보기 링크를 통해 샘플화면으로 이동합니다.(민원)" /></a></div>
				<div class="leftcontent01_btn">
					<ul>
						<li><a href="#LINK"><img src="/images/header/btn_leftcontent01.gif" width="70" height="87" alt="기술지원 필요 시 유지보수 민원" title="자세히 보기 링크를 통해 샘플화면으로 이동합니다.(민원)" /></a></li>
						<li><a href="#LINK"><img src="/images/header/btn_leftcontent02.gif" width="67" height="87" alt="구매제품  A/S민원" title="자세히 보기 링크를 통해 샘플화면으로 이동합니다.(민원)" /></a></li>
					</ul>
				</div>
			</div>
			<!-- //한번에 신청하는 민원 끝 -->
			<div class="leftcontent02">
				<div class="leftcontent02_title"><A HREF="#LINK"><img src="/images/header/img_leftcontent_title02.gif" width="210" height="71" alt="홍보물 정보 보기" title="기타자료에 대한 샘플링크 위치 표시입니다.(이동, 기능 없음)" /></A></div>
				<div class="btn_detail02"><a href="#LINK"><img src="/images/header/btn_detailview.gif" width="71" height="17" alt="자세히 보기" title="기타자료에 대한 샘플링크 위치 표시입니다.(이동, 기능 없음)" /></a></div>
			</div>
			<div class="leftcontent03">
				<div class="leftcontent03_title">
				    <a href="<c:url value='/uss/olp/qnn/EgovQustnrRespondInfoManageList.do'/>">
				    <img src="/images/header/img_leftcontent_title03.gif" width="228" height="44" alt="포털설문참여" />
				    </a>
				</div>
				...
				<div class="vote02">
                    <ul>
                        ...
                        <ul>
                            <li>
                                <a href="<c:url value='/uss/olp/qnn/EgovQustnrRespondInfoManageList.do'/>">
                                <img alt="참여하기" src="/images/header/btn_vote.gif" />
                                </a>
                            </li>
                        </ul>
                        </li>
		...
		<div id="middlecontent_wrap">
			<div id="news">
				<ul>
					<li><img alt="공지사항" src="/images/header/tab01_on.gif" /></li>
					<li><img alt="묻고답하기" src="/images/header/tab02_off.gif" /></li>
		...
		<div id="rightcontent_wrap">
			<div id="download_div">
				<div class="download_img">
				    ...
				    <img alt="최신게시물 목록" src="/images/header/img_rightcontent_title01.gif" />
				    </a>
				</div>
				<ol>
				    <c:set var="index" value="1"/>
				    <c:forEach var="result" items="${bbsList}" varStatus="status">
				    <li><img src="/images/header/num0${index}.gif" alt="" />
				        <a href="<c:url value='/cop/bbs/selectBoardList.do?bbsId=BBSMSTR_BBBBBBBBBBBB'/>">
			...
			<div id="banner_div">
			    <div class="bnpadtop"><img src="http://www.google.co.kr"> 서울날씨:, 온도:, </div>
				<div class="bnpadding"><a href="http://www.mopas.go.kr/" target="_blank"><img src="/images/header/banner_mopas.gif" alt="안정행정부" /></a></div>
				<div class="bnpadding"><a href="http://www.nia.or.kr/" target="_blank"><img src="/images/header/banner_nia.gif" alt="한국정보화진흥원" /></a></div>
				<div class="bnpadding"><a href="http://www.egovframe.go.kr/" target="_blank"><img src="/images/header/banner_egovportal.gif" alt="전자정부표준프레임워크 포털" /></a></div>
				<div class="bnpadding"><a href="http://open.egovframe.go.kr/" target="_blank"><img src="/images/header/banner_opencmm.gif" alt="오픈커뮤니티" /></a></div>
			</div>
		</div>
	</div>
	<!-- footer 시작 -->
