...
(function(m, ma) {
		...
		function e(i) {
			...
			for (P = 0; P < E; P++) {
				...
				k += " class='" + W.join(" ")
						...
						+ "px;" + M
						+ "'><div onclick='layout_total_title(this,event,&quot;"+Qa(n.total_title)+"&quot;)' class='fc-event-inner fc-event-skin'"
						+ (M ? " style='" + M + "'" : "") + " >";
				...
				if(n.title.substring(0,3)=='(출)'){

					/*k += "<font color='blue'><span class='fc-event-title' style='font-weight:bold'>" + Qa(n.title)
							+ "</span></font></div>";*/
					k += "<span class='fc-event-title' style='font-weight:bold; color:blue;'>" + Qa(n.title)
					   + "</span></div>";

				}else{
					/*k += "<font color='red'><span class='fc-event-title' style='font-weight:bold'>" + Qa(n.title)
							+ "</span></font></div>";*/
					k += "<span class='fc-event-title' style='font-weight:bold; color:red;'>" + Qa(n.title)
					   + "</span></div>";
				}
				if (B.isEnd && ra(n))
	...
	var lc = [ "sun", "mon", "tue", "wed", "thu", "fri", "sat" ], Ab = 864E5, cc = 36E5, wc = 6E4, dc = {
		...
		ddd : function(a, b) {
				if(b.dayNamesShort[a.getDay()]=='토'){
					return "<font color='blue' >"+b.dayNamesShort[a.getDay()]+"</font>";
				}else if(b.dayNamesShort[a.getDay()]=='일'){
					return "<font color='red'>"+b.dayNamesShort[a.getDay()]+"</font>";
				}
