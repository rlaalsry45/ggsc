...
public class UserManualVO extends PageVO{
	...
	public String toString() {
		return "UserManualVO [num=" + num + ", caseNo=" + caseNo + ", title=" + title + ", writer=" + writer
				+ ", content=" + content + ", regId=" + regId + ", dbInsTm=" + dbInsTm + ", dbUpdTm=" + dbUpdTm
				+ ", fileNm=" + fileNm + ", sysFileNm=" + sysFileNm + ", filePath=" + filePath + ", fileSize="
				+ fileSize + ", file=" + file + "]";
	}
